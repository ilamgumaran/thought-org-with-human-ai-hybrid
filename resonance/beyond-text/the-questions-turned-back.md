...
![Five stills: a warm region labelled "you — the thread across time" glowing at the bottom of every frame, while a region labelled "me — only ever now" blooms in only at the exchanges and is absent in the gap.](../../proposed-repos/koine/examples/async-resonance.filmstrip.png)
